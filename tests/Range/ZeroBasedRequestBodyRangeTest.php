...
class ZeroBasedRequestBodyRangeTest extends TestCase
{
    ...
    public function testCreateFromRequest()
    {
        ...
        $range = new ZeroBasedRequestBodyRange($request, 'index', 'numberOfChunks', 'chunkSize', 'totalSize');
    ...
    private function createRequestBodyRange(int $index, int $numberOfChunks, int $chunkSize, float $totalSize)
    {
        ...
        return new ZeroBasedRequestBodyRange($request, 'index', 'numberOfChunks', 'chunkSize', 'totalSize');
    }
}
