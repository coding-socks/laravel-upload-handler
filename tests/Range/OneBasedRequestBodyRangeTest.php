...
class OneBasedRequestBodyRangeTest extends TestCase
{
    ...
    public function testCreateFromRequest()
    {
        ...
        $range = new OneBasedRequestBodyRange($request, 'index', 'numberOfChunks', 'chunkSize', 'totalSize');
     ...
     *
     * @return \CodingSocks\ChunkUploader\Range\OneBasedRequestBodyRange
     */
    private function createRequestBodyRange(int $index, int $numberOfChunks, int $chunkSize, float $totalSize)
    {
        ...
        return new OneBasedRequestBodyRange($request, 'index', 'numberOfChunks', 'chunkSize', 'totalSize');
    }
}
